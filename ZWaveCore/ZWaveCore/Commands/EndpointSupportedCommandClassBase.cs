...
{
    public abstract class EndpointSupportedCommandClassBase : CommandBase
    {
        private readonly byte _endpointId;

        protected EndpointSupportedCommandClassBase(ZWaveNode node, CommandClass commandClass) :
        ...
        protected EndpointSupportedCommandClassBase(ZWaveNode node, CommandClass commandClass, byte endpointId)
